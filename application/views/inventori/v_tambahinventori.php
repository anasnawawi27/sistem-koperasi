            ...
            <div class="card-body">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8">
                            <form method="POST" action="<?= base_url() ?>inventori/tambah">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="kode_barang" id="kodeBarangInv" autocomplete="off" value="<?= set_value('kode_barang') ?>"
                                ...
                                <div class="form-group">
                                    <input class="form-control" type="hidden" name="id_barang" autocomplete="off" id="idBarangInv"/>
                                    <small class="form-text text-danger"><?= form_error('id_barang'); ?></small>
                                </div>
                                <div class="form-group">
                                    <label>Nama Barang</label>
                                    <input class="form-control" type="text" name="nama_barang" autocomplete="off" value="<?= set_value('nama_barang') ?>" readonly id="namaBarangInv"/>
                                    <small class="form-text text-danger"><?= form_error('nama_barang'); ?></small>
                                </div>
                                <div class="form-group">
                                    <label>Detail</label>
                                    <Input class="form-control" rows="4" name="detail_barang" value="<?= set_value('detail_barang') ?>"
                                    readonly id="detailBarangInv">
                                    <small class="form-text text-danger"><?= form_error('detail_barang'); ?></small>
                                </div>
                                <div class="form-group">
                                    <label>QTY</label>
                                    <input class="form-control" type="number" name="qty" autocomplete="off" value="<?= set_value('qty') ?>" id="qty"/><small class="form-text text-danger"><?= form_error('qty'); ?></small>
                                </div>
                        ...
                        <div class="col-sm-4">
                                <img src="<?= base_url() ?>material/assets/img/drawkit/color/drawkit-folder-man.svg" style="margin-top: 100px; width: 300px">
                        </div>
